...
public class StringEncrypter
{
	...
	public synchronized String encrypt(String clearText) throws EncryptionException
	{
		if (clearText == null || clearText.trim().length() < 1)
		{
			throw new IllegalArgumentException("clear-text string was null or empty");
		}
	...
	//this is not working.....
	public synchronized String decrypt(String clearText) throws EncryptionException
	{
		if (clearText == null || clearText.trim().length() < 1)
		{
			throw new IllegalArgumentException("clear-text string was null or empty");
		...
		try
		{
			...
			return this.base64decoder.decodeBuffer(cipherTextBytes.toString()).toString();
		}
		catch (Exception e)
		{
			throw new EncryptionException(e);
